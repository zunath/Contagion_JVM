...
import contagionJVM.Data.HeadDTO;
...
public class Conversation_ChangeHead extends DialogBase implements IDialogHandler {
    ...
    public PlayerDialog SetUp(NWObject oPC) {
        ...
        mainPage.setCustomData(new HeadDTO(NWScript.getCreatureBodyPart(CreaturePart.HEAD, oPC)));
    ...
    {
        NWObject oPC = GetPC();
        HeadDTO dto = (HeadDTO)GetCurrentPage().getCustomData();
